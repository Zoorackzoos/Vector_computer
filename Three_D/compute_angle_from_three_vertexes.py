...
def compute_angle_from_three_vertexes(vertex_a, vertex_b,vertex_c, tab_amount):
    ...
    ab_ac_dot_product = compute_dot_product_3d(vertex_ab, vertex_ac, tab_amount + '\t')
    ...
    ba_bc_dot_product = compute_dot_product_3d(vertex_ba, vertex_bc, tab_amount + '\t')
    ...
    ca_cb_dot_product = compute_dot_product_3d(vertex_ca, vertex_cb, tab_amount + '\t')
